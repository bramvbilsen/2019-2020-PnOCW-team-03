...
export default class Animation {
    ...
    public ratioAngle = (
        ...
        const LeftUp = this.stringToPoint(
            slave.mapMasterToActualCornerLabel(CornerLabels.LeftUp),
            slave
        );
        const RightUp = this.stringToPoint(
            slave.mapMasterToActualCornerLabel(CornerLabels.RightUp),
            slave
        );
        const LeftUnder = this.stringToPoint(
            slave.mapMasterToActualCornerLabel(CornerLabels.LeftUnder),
            slave
        );
        const RightUnder = this.stringToPoint(
            slave.mapMasterToActualCornerLabel(CornerLabels.RightUnder),
            slave
        );
