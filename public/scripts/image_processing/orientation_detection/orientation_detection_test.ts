...
function labelingTest1(
    ...
    var correct =
        ...
        result[3] == expectedResult[3];
    console.log(correct);
}

function labelingTest2(
    fct: (
        p1: Point,
        p2: Point,
        p3: Point,
...
/* 3) ANGLE-TESTS */
function angleSpeedTest(
    fct: (p1: Point, p2: Point, p3: Point, p4: Point) => number,
    p1: Point,
    p2: Point,
    p3: Point,
    p4: Point
    ...
    var time = +end - +start;
    console.log(
        "The algorithm to calculate the Angle took ",
        time,
        "milliseconds"
    );
}
